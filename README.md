...
Please note, our project was developed using the free SQL Express which associates DB instance name with the machine name. If another version is used, you might also need to comment out the logic connection string that builds connection string.</li>
