            ...
            switch (args[0]) {
                case "update": {
                    ...
                    try {
                        ...
                        formatter.printHelp("csrc update", options);
                        System.exit(1);
                        return;
                    }
                    ...
                    Preferences prefs = Preferences.userNodeForPackage(gov.nist.csrc.CloudSecurityRubiksCube.class);
                    try {
                        prefs.clear();
